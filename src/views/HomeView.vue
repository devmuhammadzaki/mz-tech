      ...
      <div class="container">
        ...
        <div class="str-feature-content owl-carousel" id="str-slide">
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
            <a href="ar/services/1.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_803-1640779601.png" alt="تصميم المواقع" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>تصميم المواقع</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      <span dir="RTL">نحن متخصصون فى تصميم و برمجة تطبيقات ومواقع الإنترنت
                        الاحترافية نساعدك على تحقيق أهدافك.</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="100ms" data-wow-duration="1500ms">
            <a href="ar/services/2.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_600-1640779623.png" alt="تطوير المواقع الإلكترونية" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>تطوير المواقع الإلكترونية</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      لدينا فريق مُدرب ومتميز متخصص فى تطوير التطبيقات ومواقع
                      الويب.
                    </p>
                  </div>
                </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <a href="ar/services/3.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_514-1640779713.png"
                    alt="برمجة تطبيقات الهاتف المحمول" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>برمجة تطبيقات الهاتف المحمول</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      نوفر لعملائنا برمجة وتطوير تطبيقات الهاتف المحمول بأحدث
                      التقنيات.
                    </p>
                  </div>
                </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms">
            <a href="ar/services/4.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_102-1640769364.png" alt="خدمات الاستضافة" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>خدمات الإستضافة</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      متخصصون فى خدمة الإستضافة حيث نقوم بإستضافة مواقع ويب و
                      حجز دومين وإختيار أسماء النطاقات المتوفرة.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="400ms" data-wow-duration="1500ms">
            <a href="ar/services/5.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_425-1640769468.png" alt="تصميم الهويات التجارية" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>تصميم الهويات التجارية</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      نساعدك بإبراز خبراتك ومهاراتك فى سوق العمل من خلال تصميم
                      هويتك التجارية بطريقة مبتكرة وفريدة.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="500ms" data-wow-duration="1500ms">
            <a href="ar/services/23.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_116-1680677746.jpg"
                    alt="تأسيس شركات واستثمار اجنبي في مصر" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>تأسيس شركات واستثمار اجنبي في مصر</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      نساعدك على تأسيس شركتك والإستثمار فى مصر والوصول
                      للنجاح&nbsp;
                    </p>
                  </div>
                </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="600ms" data-wow-duration="1500ms">
            <a href="ar/services/8.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_182-1640770323.png" alt="تصميم فيديو موشن جرافيك" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>تصميم فيديو موشن جرافيك</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      نحن متخصصون في تصميم الأفلام الوثائقية، الفيديوهات
                      التعريفية، فيديوهات الشركات والمشاريع، بالإضافة إلى موشن
                      جرافيك لليوتيوب. كما نقدم خدمات التعليق الصوتي بهدف عرض
                      خدماتكم بكفاءة واحترافية.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="700ms" data-wow-duration="1500ms">
            <a href="ar/services/9.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_909-1640770547.png" alt="الاستشارات الإدارية" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>الاستشارات الإدارية</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      <span dir="RTL">لدينا نخبة من المتخصصين على مستوى عالى من الكفاءة
                        لمساعدتك على إعادة هيكلة النظام الإدارى وتطويره ووضع
                        أساس إدارى سليم يساعد على نجاح مشروعك .</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="800ms" data-wow-duration="1500ms">
            <a href="ar/services/10.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_424-1640770705.png" alt="الاستشارات التقنية" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>الاستشارات التقنية</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      نقدم خبرة عملية الهدف منها تقديم استشارات تقنية
                      متكاملة&nbsp; لمساعدتك فى تحسين المستوى التقنى ومستوى
                      الخدمة لديك.
                    </p>
                  </div>
                </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="900ms" data-wow-duration="1500ms">
            <a href="ar/services/11.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_998-1640771043.png" alt="استشارات رجال الأعمال" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>استشارات رجال الأعمال</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      هدفنا مساعدتك على النجاح والارتقاء بعملك لذلك نوفر خدمة
                      استشارات رجال الأعمال لدينا متخصصين متميزين فى تقديم
                      الاستشارات وتأسيس الشركات والاستثمار الأجنبى فى مصر
                      والخدمات المساندة لفرق التقنية.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="1000ms" data-wow-duration="1500ms">
            <a href="ar/services/12.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_376-1640771891.jpg"
                    alt="إدارة حسابات السوشيال ميديا" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>إدارة حسابات السوشيال ميديا</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      <span dir="RTL">لدينا فريق متكامل متخصص لمساعدتك فى إدارة حسابات
                        السوشيال ميديا والعمل على توضيح خدماتك العملية بشكل
                        متميز.
                      </span>
                    </p>
                  </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="1100ms" data-wow-duration="1500ms">
            <a href="ar/services/13.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_495-1640774763.jpg" alt="التسويق الإلكتروني" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>التسويق الإلكتروني</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      <span dir="RTL">نوفر خدمة التسويق الإلكترونى ولدينا فريق متخصص فى إدارة
                        الحملات الإعلانية.</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="str-feature-box wow fadeFromUp" data-wow-delay="1200ms" data-wow-duration="1500ms">
            <a href="ar/services/14.html">
              <div class="str-hover-icon text-center">
                <i class="fas fa-plus"></i>
              </div>
              <div class="str-feature-icon-text text-center">
                <div class="str-feature-icon">
                  <img src="../assets/storage/Services/_services_646-1640776110.png" alt="بوابات الدفع الإلكتروني" />
                </div>
                <div class="str-feature-text str-headline">
                  <h3>بوابات الدفع الإلكتروني</h3>
                  <div class="str-feature-list ul-li-block">
                    <p>
                      <span dir="RTL">نوفر نظام آمن وسريع لسهولة التعامل بين العملاء ومقدمى
                        الخدمة.</span>
                    </p>
                  </div>
                </div>
