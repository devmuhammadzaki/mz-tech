        ...
        <div class="container-fluid">
            ...
            <div class="s2-pricing_content">
                <div class="row justify-content-md-center">
                    <div class="col-lg-3 col-md-6 wow fadeFromLeft animated" data-wow-delay="0ms"
                        data-wow-duration="1500ms" style="
                visibility: visible;
              ...
              ">
                        <div class="s2-pricing_item">
                            ...
                            <div class="s2-pricing_btn">
                                <RouterLink to="/contactus"><i class="fas fa-cloud-download-alt"></i>جرب الآن
                                </RouterLink>
                            </div>
                        </div>
                    </div>
